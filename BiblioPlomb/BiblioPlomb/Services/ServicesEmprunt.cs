...
{
    public class ServicesEmprunt : Controller
    {
        private readonly BiblioPlombContext _context;

        public ServicesEmprunt(BiblioPlombContext context)
        {
            _context = context;
        }

        // GET: Emprunts (Tout les livres)
        public async Task<IActionResult> Index()
        {
            return View(await _context.Emprunt.ToListAsync());
        }

        // GET: Emprunts/Details/5 (Voir les déails d'un seul livre)
